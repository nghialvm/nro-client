...
namespace QLTK
{
    ...
    public partial class MainWindow : Window
    {
        ...
        static MainWindow()
        {
            ...
            Servers.Add(new Server("NRO", "160.30.160.184", 14445));
        ...
        private async Task OpenGameAsync(Account account)
        {
            if (account.process == null || account.process.HasExited)
            {
                ...
                if (FullScreenCheckBox.IsChecked == false)
                {
                    ...
                    int screenWidth  = SystemParameters.PrimaryScreenWidth > 0
                        ? (int)SystemParameters.PrimaryScreenWidth
                        : 0; // SM_CXSCREEN

                    int screenHeight = SystemParameters.PrimaryScreenHeight > 0
